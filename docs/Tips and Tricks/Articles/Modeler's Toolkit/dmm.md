...
* "Incorrect Probe Connections" Warning - Most of us have tried to measure voltage with the probes in the current measurement position, which leads to blown fuses, fried probe tips, and sometimes damage to the meter or the user.  There was an incident in college where Michael did this across an electric vehicle pack.  He managed to vaporize most of a probe tip and give himself nasty burns all over the hand that was holding it, along with creating a flash and bang that scared the crap out of the rest of us.  Nothing like 10,000 amps suddenly racing through your meter to really liven up the morning.  A good meter will give you an audible warning that your probe connections don't match what you've selected to measure.   
...
In this range, I'd recommend something like the Uni-T UT61E+.  Uni-Trend is a Chinese instrument brand that has been around for a while and generally builds some decent kit. They're not high end, but the general consensus is that they're generally solid tools.  
