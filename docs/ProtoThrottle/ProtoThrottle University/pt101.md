...
Nickel-Metal Hydride (NiMH).  With two pairs of batteries, one pair can be
...
the easiest receiver setup.  Simply plug the
[receiver](https://www.iascaled.com/store/MRBW-CABBUS) into the command
station network.  It comes preconfigured to work with NCE Cab Bus.  If you
are using Lenz XpressNet, be sure to change DIP switch A to ON.
...
user manual that came with the receiver or the [Receiver Setup](receivers.md#nce-cab-bus-and-lenz-xpressnet) page for details.

### ESU CabControl, JMRI WiFi Throttle, and Digitrax LNWI

The second receiver covers almost everything else.  This
[receiver](https://www.iascaled.com/store/MRBW-WIFI) communicates wirelessly
with the command station using a variety of protocols.
...
receiver or the [Receiver Setup](receivers.md#esu-cabcontrol-jmri-wifi-throttle-and-digitrax-lnwi) page for details.


## Menu Navigation

While the most common controls on the ProtoThrottle are designed to be physical,
